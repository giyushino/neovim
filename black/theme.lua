return {
  {
    ...
    config = function()
      ...
      vim.api.nvim_set_hl(0, "NvimTreeFolderName", { fg = "#8E8E8E", bg = "None" })
      vim.api.nvim_set_hl(0, "Normal", { fg = "#ffffff", bg = "#1c1c1c" })
      vim.api.nvim_set_hl(0, "Keyword", { fg = "#eae7e6", bg = "None" })
      vim.api.nvim_set_hl(0, "Comment", { fg = "#e5dfda", bg = "#1c1c1c" })
      vim.api.nvim_set_hl(0, "Boolean", { fg = "#D3D3D3", bg = None})
      vim.api.nvim_set_hl(0, "@keyword.return", { fg = "#eae7e6", bold = true })
      vim.api.nvim_set_hl(0, "@keyword", { fg = "#eae7e6", bold = true })
      vim.api.nvim_set_hl(0, "@function.builtin", { fg = "#A0A1A0", bold = true })
      vim.api.nvim_set_hl(0, "@variable.builtin", { fg = "#DEDEDE", bold = true })
      vim.api.nvim_set_hl(0, "@function.call", { fg = "#C5C6D0", bold = true })
      vim.api.nvim_set_hl(0, "@variable.parameter", { fg = "#DADADA", bold = true })
